...
<div class="row" id="popular">
    <div class="col-md-12">
        <h3><?php echo __('Popular Slides'); ?>&nbsp;&nbsp;<small><a href="http://localhost/open-slideshare-0.3.0/slides/popular"><?php echo __('More...'); ?></a></small></h3>
...
<div class="row" id="latest">
    <div class="col-md-12">
        <h3><?php echo __('Latest Slides'); ?>&nbsp;&nbsp;<small><a href="http://localhost/open-slideshare-0.3.0/slides/latest"><?php echo __('More...'); ?></h3>
