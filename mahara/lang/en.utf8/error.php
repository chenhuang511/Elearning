...
$string['cssnotpresent'] = 'CSS files are not present in your htdocs/theme/lms/style directory. If you are running Mahara from a git checkout, run "make css" to build the CSS files. If you are running Mahara from a ZIP download, try downloading and unzipping again.';
