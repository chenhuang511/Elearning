...
{if $folder != '/'}
    <tr class="{cycle values='r0,r1'}">
        <td><img src="{$rootpath}static/file/theme/lms/static/images/folder.png" alt="{str tag=Folder section=artefact.file}"></td>
...
{foreach from=$files item=file}
    <tr class="{cycle values='r0,r1'}">
        <td><img src="{$rootpath}static/file/theme/lms/static/images/file.png" alt="{str tag=File section=artefact.file}"></td>
