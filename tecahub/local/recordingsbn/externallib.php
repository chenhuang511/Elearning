 ...
 * @since Moodle 2.2
 */
class local_mod_recordingsbn_external extends external_api {
    /**
     * Hanv 24/05/2016
     ...
     *
     */
    public static function get_mod_recordingsbn_by_id_parameters() {
     ...
     * @since Moodle 2.2
     */
    public static function get_mod_recordingsbn_by_id($id) {
        global $CFG, $DB;

        //validate parameter
        $params = self::validate_parameters(self::get_mod_recordingsbn_by_id_parameters(), array('id' => $id));

        return $DB->get_record('recordingsbn', array('id' => $params['id']), '*', MUST_EXIST);
    }
     ...
     * @since Moodle 2.2
     */
    public static function get_mod_recordingsbn_by_id_returns() {
        return  new external_single_structure(
            array(
				...
				'ui_html' => new external_value(PARAM_INT, 'Standard Moodle primary key.'),
				'include_deleted_activities' => new external_value(PARAM_INT, 'Standard Moodle primary key.')
            )
        );
    }
}
