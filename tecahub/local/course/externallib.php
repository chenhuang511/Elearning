...
class local_course_external extends external_api
{
    ...
    public static function create_new_mods_parameters()
    {
        return new external_function_parameters(
            array(
                'courseid' => new external_value(PARAM_INT, 'the id of course'),
    ...
    public static function create_new_mods($courseid, $add, $section, $sectionreturn)
    {
        ...
        if (!$course) {
            $warnings['message'] = "Not found information about this course";
        }
        ...
        if (file_exists($modmoodleform)) {
            ...
            $warnings['message'] = "No Form Description";
        }
    ...
    public static function create_new_mods_returns()
    {
        return new external_single_structure(
            array(
                'warnings' => new external_warnings()
