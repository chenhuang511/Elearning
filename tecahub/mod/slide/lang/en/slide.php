...
$string['createurl'] = 'Create a Slide';
...
$string['modulename_link'] = 'mod/slide/view';
$string['modulenameplural'] = 'Slides';
$string['page-mod-slide-x'] = 'Any Slide module page';
...
$string['printintroexplain'] = 'Display Slide description below content? Some display types may not display description even if enabled.';
$string['rolesinparams'] = 'Include role names in parameters';
$string['search:activity'] = 'slide';
$string['serverurl'] = 'Server URL';
$string['slide:addinstance'] = 'Add a new Slide resource';
$string['slide:view'] = 'View Slide';
