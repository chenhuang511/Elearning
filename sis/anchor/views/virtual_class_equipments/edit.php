	...
	<div class="col-md-12">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <select name="status">
                        <option value="0" <?php if($virtual_class_equipments->status == 0) echo "selected"; ?>>Hỏng</option>
                        <option value="1" <?php if($virtual_class_equipments->status == 1) echo "selected"; ?>>Tốt</option>
                    </select>
                </td>
            </tr><!-- 
            <tr>
