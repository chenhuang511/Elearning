...
<section class="wrap">
    ...
    <?php if (Auth::admin() || Auth::me($user->id)) : ?>
        <form method="post" action="<?php echo Uri::to('admin/users/info/' . $user->id); ?>" novalidate
    ...
    <?php else : ?>
        <p>You do not have the required privileges to modify this users information, you must be an Administrator.
            Please contact the Administrator of the site if you are supposed to have these privileges.</p>
