...
<section class="wrap">
    ...
    <?php if(Auth::admin()) : ?>
        ...
        <form method="post" action="<?php echo Uri::to('admin/schools/add'); ?>" novalidate autocomplete="off" enctype="multipart/form-data">
...
<!--                </p>-->
    ...
    <?php else : ?>
        <p>You do not have the required privileges to add schools, you must be an Administrator. Please contact the Administrator of the site if you are supposed to have these privileges.</p>
