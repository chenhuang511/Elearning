                        ...
                        <div class="panel-body">
                            ...
                            <div class="virtual_class_equipment-box clearfix">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div
                                            class="form-group <?php if (isset($errors['virtual_class_equipment_' . $key])) {
                                                echo 'has-error';
                                            } else {
                                                echo '';
                                            } ?>">
                                            <label for="virtual_class_equipment_<?php echo $key; ?>"
                                                   class="control-label"><?php echo __('equipment.virtual_class_equipment') ?>
                                                <span
                                        ...
                                        <div
                                            class="form-group <?php if (isset($errors['description_virtual_class_equipment_' . $key])) {
                                                echo 'has-error';
                                            } else {
                                                echo '';
                                            } ?>">
                                        ...
                                        <div
                                            class="form-group <?php if (isset($errors['quantity-virtual_class_equipment_' . $key])) {
                                                echo 'has-error';
                                            } else {
                                                echo '';
                                            } ?>">
                                ...
                                <div class="form-group text-right">
                                    <input type="hidden" id="id_virtual_class_equipment_<?php echo $key; ?>"
                                           name="id_virtual_class_equipment_<?php echo $key; ?>"
                                           value="<?php echo $key; ?>">
