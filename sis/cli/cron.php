<?php
 ...
 function get_remote_network_peer()
 {
     ...
     $stid = oci_parse($conn, 'SELECT * FROM m_user');
     oci_execute($stid);
     while ($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
         ...
         $timecreate  = $row["TIMECREATED"];

         //if($password != " ") {
            $sql = "INSERT INTO anchor_students VALUES('" . $id . "'" . " ,'" .  $username . "'" . " , '" . $firstname . "'" . " ,
                                                       '" . $lastname . "'" . " , '" . $email . "'" . " , '" . $address . "'" . " ,
                                                       '" . $city . "'" . " , '" . $firstaccess . "'" . " , '" . $lastaccess . "'" . " ,
                                                       '" . $lastlogin . "'" . " , '" . $timecreate . "')";
            $mysqlconn->query($sql);
            echo $username;
            echo "<br>";
         //}
