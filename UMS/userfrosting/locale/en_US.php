...
$lang = array_merge($lang,array(
	...
	"MEMBERS_COHORT_ADDED" => "Added members to cohort '{{name}}'.",
	"MEMBERS_COHORT_REMOVED" => "Removed members to cohort '{{name}}'.",
	"COHORT_DELETION_SUCCESSFUL" => "Successfully deleted cohort '{{name}}'",
	"COHORT_NAME_CHAR_LIMIT" => "Cohort names must be between {{min}} and {{max}} characters in length",
	"COHORT_ID_CHAR_LIMIT" => "Cohort ID must be between {{min}} and {{max}} characters in length",
