...
return array(
    ...
    'UserFrosting\\MdlConfig' => $baseDir . '/models/database/MdlConfig.php',
    ...
    'UserFrosting\\MdlExternalServicesUsers' => $baseDir . '/models/database/MdlExternalServicesUsers.php',
    'UserFrosting\\MdlExternalTokens' => $baseDir . '/models/database/MdlExternalTokens.php',
    'UserFrosting\\MdlGradeGrades' => $baseDir . '/models/database/MdlGradeGrades.php',
    'UserFrosting\\MdlGroupMembers' => $baseDir . '/models/database/MdlGroupMembers.php',
    'UserFrosting\\MdlMessage' => $baseDir . '/models/database/MdlMessage.php',
    'UserFrosting\\MdlMessageRead' => $baseDir . '/models/database/MdlMessageRead.php',
    'UserFrosting\\MdlMessageWorking' => $baseDir . '/models/database/MdlMessageWorking.php',
    'UserFrosting\\MdlMyPages' => $baseDir . '/models/database/MdlMyPages.php',
    ...
    'UserFrosting\\MdlUserEnrolments' => $baseDir . '/models/database/MdlUserEnrolments.php',
    'UserFrosting\\MdlUserInfoData' => $baseDir . '/models/database/MdlUserInfoData.php',
    'UserFrosting\\MdlUserLastaccess' => $baseDir . '/models/database/MdlUserLastaccess.php',
    'UserFrosting\\MdlUserPasswordHistory' => $baseDir . '/models/database/MdlUserPasswordHistory.php',
    'UserFrosting\\MdlUserPreferences' => $baseDir . '/models/database/MdlUserPreferences.php',
    'UserFrosting\\MdlUserPrivateKey' => $baseDir . '/models/database/MdlUserPrivateKey.php',
