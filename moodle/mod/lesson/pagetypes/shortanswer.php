...
class lesson_page_type_shortanswer extends lesson_page {
    ...
    public function display($renderer, $attempt) {
        ...
        $mform = new lesson_display_answer_form_shortanswer($CFG->wwwroot.'/mod/lesson/remote/continue.php', array('contents'=>$this->get_contents(), 'lessonid'=>$this->lesson->id));
        $data = new stdClass;
        $data->id = $PAGE->cm->id;
    ...
    public function check_answer() {
        ...
        $mform = new lesson_display_answer_form_shortanswer($CFG->wwwroot.'/mod/lesson/remote/continue.php', array('contents'=>$this->get_contents()));
        $data = $mform->get_data();
        require_sesskey();
