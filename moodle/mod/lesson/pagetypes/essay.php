...
class lesson_page_type_essay extends lesson_page {
    ...
    public function display($renderer, $attempt) {
        ...
        $mform = new lesson_display_answer_form_essay($CFG->wwwroot.'/mod/lesson/remote/api-continue.php', array('contents'=>$this->get_contents(), 'lessonid'=>$this->lesson->id));
    ...
    public function check_answer() {
        ...
        $mform = new lesson_display_answer_form_essay($CFG->wwwroot.'/mod/lesson/remote/api-continue.php', array('contents'=>$this->get_contents()));
        $data = $mform->get_data();
        require_sesskey();
