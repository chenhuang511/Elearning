...
if (!is_null($discussionid)) {
    ...
    if (MOODLE_RUN_MODE === MOODLE_MODE_HUB) {
        $forum = $DB->get_record('forum', array('id' => $id), 'id, remoteid');
        $param = array();
        $param['parameters[0][name]'] = "id";
        $param['parameters[0][value]'] = $discussionid;
        $param['parameters[1][name]'] = "forum";
        $param['parameters[1][value]'] = $forum ? $forum->remoteid : $id;
