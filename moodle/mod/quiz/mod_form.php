...
class mod_quiz_mod_form extends moodleform_mod {
    ...
    protected function definition() {
        ...
        if($isdisable){
            $this->remote_intro_elements(get_string('introduction', 'quiz'));
        }else{
        ...
        if($isdisable){
            $this->checkDisable('shuffleanswers', true);
        }
        ...
        if($isdisable){
            $this->checkDisable('preferredbehaviour', true);
        }
        ...
        if($isdisable){
            $this->checkDisable('canredoquestions', true);
        }
        ...
        if($isdisable){
            $this->checkDisable('attemptonlast', true);
        }
