...
/**
 * Strings for component 'webservice', language 'vi', branch 'MOODLE_31_STABLE'
 *
 * @package   webservice
...
$string['enablemobilewsoverview'] = 'Đến trang quản trị {$a->manageservicelink}, chọn thiết lập "{$a->enablemobileservice}" và Lưu. Mọi thứ sẽ được thiết lập cho bạn và tất cả người dùng trang sẽ có thể sử dụng ứng dụng Moodle chính thức. Tình trạng hiện tại: {$a->wsmobilestatus}';
...
$string['mobilewsdisabled'] = 'Đã bị vô hiệu hóa';
$string['mobilewsenabled'] = 'Đã được kích hoạt';
