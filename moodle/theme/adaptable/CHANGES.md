...
- Fix #449 'People' item in 'This course' menu is not displayed in local language 
- Fix #446 Failed to control 'Course Full Name' / 'Course Short Name' setting for the breadcrumb 
- Fix #445 Header height has a 'hidden' limit 
- Fix #444 Neither site title nor course title in the header 
- Fix #441 Multi-lang content not displayed in the marketing blocks 
- Fix #440 Preferences menu item enable by default 
- Fix #432 Update Font Awesome to 4.6
- Fix #429 Teacher Style front Page Tiles 
