...
$string['configtitle'] = 'Hệ thống đào tạo trực tuyến Tekapro Việt Nam';
$string['connectus'] = 'Contact with us';
$string['contact'] = 'Contact';
$string['copyright_footer'] = 'Copyright';
$string['copyright_default'] = 'Copyright &copy; 2016 - Developed by <a href="http://nccsoft.vn">nccsoft.vn</a>. Powered by <a href="https://moodle.org">Moodle</a>';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Whatever CSS rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
$string['defaultaddress'] = '6th floors, No 6th, Ton That Thuyet Street, Cau Giay District, Ha Noi, Vietnam';
$string['defaultemailid'] = 'info@nccosft.vn';
$string['defaultphoneno'] = '(000) 123-456';
$string['emailid'] = 'Email';
$string['fburl'] = 'Facebook';
$string['fburl_default'] = 'https://www.facebook.com/nccsoft';
